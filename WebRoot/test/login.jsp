...
<html>
  <head>
   ...
   <meta http-equiv="Content-Language" content="zh-cn">
		...
		<script language = "JavaScript" src = "js/main.js?t=<%=new Date().getTime()%>"></script>
	</head>
...
<!--文件体开始-->
	...
	<form action="LoginServlet2" method=post name="login">
		...
		<td valign=middle class=tablebody1>请输入您的用户名</td>
			<td valign=middle class=tablebody1><INPUT name=userid type=text id="userid"> &nbsp;
				<a href="register.jsp">没有注册？</a>
			</td>
		</tr>
		<tr>
			<td valign=middle class=tablebody1>请输入您的密码</td>
			<td valign=middle class=tablebody1><INPUT name=password type=password id="password"> &nbsp; </td>
		</tr>
		<tr>
