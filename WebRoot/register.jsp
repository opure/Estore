    ...
    <meta http-equiv="Content-Language" content="zh-cn">
		...
		<script language = "JavaScript" src = "js/main.js"></script>
			...
			function checkUserName(){
				...
				//注册回调函数
				//处理响应信息
				xhr.onreadystatechange=xxcallback;
				/* xhr.onreadystatechange=function(){
				//响应状态  4代表请求成功发送 且响应已经就绪 
					if(xhr.readyState==4&xhr.status==200){
						msg.innerHTML="<b style='color:red'>"+xhr.responseText+"</b>";
					}
				} */
				//设置连接信息  你要连谁
				xhr.open("GET","CheckUserNameServlet?userid="+userid.value,true);
				//设置参数 并发送请求
				xhr.send(null);
...
<form method="post" name="reg" action="RegisterServlet" >
	<table cellpadding="3" cellspacing="1" align="center" class="tableborder1" id="table1">
		...
		<tr>
			...
			<input maxLength="8" size="32" id="userid" name="userid" style="font-family: Tahoma,Verdana,宋体; font-size: 12px; line-height: 15px; color: #000000" onblur="checkUserName()">
