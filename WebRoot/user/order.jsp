...
<!--文件体开始-->
		...
		<tr>
            ...
            <c:forEach items="${orderforms }" var="o" varStatus="status">
		<tr>
			<td class=tablebody2 valign=middle align=center width="">${status.count }</td>
			<td class=tablebody1 valign=middle width="">&nbsp;&nbsp;<a href="user/orderinfo.jsp?orderid=1">${o.id }</a></td>
			<td class=tablebody2 valign=middle align=left width="">&nbsp;&nbsp;￥${o.total }</td>
			<td class=tablebody1 valign=middle align=center width="">${o.status }</td>
			<td class=tablebody2 valign=middle align=left width="">&nbsp;&nbsp;${o.payway } </td>
			<td class=tablebody1 valign=middle align=center width="">
			<input type="button" value="删除" onclick="javascript:window.location='user/removeOrder.action?orderid=1';">&nbsp;<input type="button" value="明细" onclick="javascript:window.location='user/ShowOrderFormDetailServlet?orderid=${o.id}';"><!--&nbsp;<input type="button" value="修改"/>--> </td>
		</tr>
              </c:forEach>  
                </table><br>
<!--文件尾开始-->
