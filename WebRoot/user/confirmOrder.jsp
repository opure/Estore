...
<!--文件体开始-->
		...
		<form name="order" method="post" action="user/ConfirmOrderServlet"/>
		...
		<tr>
			...
			<td class="tablebody1">${user.lianxi1}</td>
		</tr>
		<tr>
			<td class="tablebody2" align="right"><b>邮编</b>：</td>
			<td class="tablebody1">${user.youbian}</td>
		</tr>
		<tr>
			<td class="tablebody2" align="right"><b>家庭电话</b>：</td>
			<td class="tablebody1">${user.tel}</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td class="tablebody1">${user.shouji}</td>
		</tr>
		<tr>
...
<!--文件尾开始-->
		...
		<tr>
			...
			<td class=tablebody1 valign=middle width="">&nbsp;&nbsp;<a href="productDetail.jsp?productid=2" target="_blank">${o.productName }</a></td>
			<td class=tablebody2 valign=middle align=center width="">价格：${o.price }</td>
			<td class=tablebody1 valign=middle align=center width="">数量：${o.count }</td>
			<td class=tablebody2 valign=middle align=left width="">小计：￥${o.total }</td>
		</tr>
               </c:forEach> 
		<tr>
